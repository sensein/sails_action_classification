"""
Tests for src.src.sailsprep.tracking_pose_model_testing.deepsort
...
def patch_imports(monkeypatch):
    ...
    monkeypatch.delitem(
        sys.modules,
        "src.sailsprep.tracking_pose_model_testing.deepsort",
        raising=False,
    )
    yield
...
def _import_draw_pose():
    from src.sailsprep.tracking_pose_model_testing.deepsort import draw_pose
    return draw_pose
