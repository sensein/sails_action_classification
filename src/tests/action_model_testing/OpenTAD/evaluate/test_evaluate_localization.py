"""
Tests for src/sailsprep/action_model_testing/OpenTAD/evaluate/evaluate_localization.py
...
_EVAL_DIR = (
    ...
    / "sailsprep" / "action_model_testing" / "OpenTAD" / "evaluate"
)
...
def _load_module():
    ...
    # resolves fresh to OpenTAD/evaluate/common.py.
    ...
    try:
        ...
        # OpenTAD/evaluate/. Purge it so it can't shadow the unrelated
