"""
Tests for src/sailsprep/action_model_testing/open_tad/prepare_data/prepare_data.py
"""
...
_MODULE_PATH = (
    ...
    / "sailsprep" / "action_model_testing" / "open_tad" / "prepare_data" / "prepare_data.py"
)
