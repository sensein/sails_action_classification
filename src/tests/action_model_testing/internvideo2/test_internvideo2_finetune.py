...
# modules are only good enough for loading internvideo2_finetune.py itself — leaving
...
_mod_path = _SRC_ROOT / "sailsprep" / "action_model_testing" / "internvideo2" / "internvideo2_finetune.py"
if not _mod_path.exists():
    raise FileNotFoundError(
        f"internvideo2_finetune.py not found at expected path: {_mod_path}\n"
...
# Restore real modules (or remove the stub) now that internvideo2_finetune.py is loaded,
