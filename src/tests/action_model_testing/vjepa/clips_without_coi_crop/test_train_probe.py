...
from sailsprep.action_model_testing.vjepa.clips_without_coi_crop.train_probe import (
    EMBED_DIM,
    AttentiveProbe,
    FeatureDataset,
    run_inference,
...
class TestTrainProbe:
    ...
    def test_runs_one_epoch_and_saves_log(self, tmp_path, monkeypatch):
        import sailsprep.action_model_testing.vjepa.clips_without_coi_crop.train_probe as mod
