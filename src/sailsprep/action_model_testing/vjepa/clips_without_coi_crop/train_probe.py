"""
VJEPA2 ViT-G — Attentive Probe Training (Per Seed)
====================================================
Loads pre-extracted features (shared across seeds), does train/test split
...
Output per seed:
    /orcd/data/satra/002/projects/SAILS/vjepa_features/models_output_seeds/clips/vjepa/
    └── seed_42/
        ├── best_probe.pt
        ├── label_mapping.json
        ├── test_split.csv
...
NUM_CLASSES   = 5
BATCH_SIZE    = 32         # fast — features are pre-extracted
MAX_EPOCHS    = 50
LEARNING_RATE = 1e-3
WEIGHT_DECAY  = 0.05
TEST_SPLIT    = 0.30
...
def main():
    ...
    # Save label map for this seed run
    ...
    print(f"\nSeed {seed} complete! Results in: {seed_dir}")
