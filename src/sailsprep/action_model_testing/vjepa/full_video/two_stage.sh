...
#SBATCH --array=0-2
#SBATCH --output=/home/aparnabg/orcd/scratch/all_project_files/action_sota_models/vjepa_code_frame_window/logs/%x_%A_%a_two.out
#SBATCH --error=/home/aparnabg/orcd/scratch/all_project_files/action_sota_models/vjepa_code_frame_window/logs/%x_%A_%a_two.err
...
python /home/aparnabg/orcd/scratch/all_project_files/action_sota_models/vjepa_code_frame_window/two_stage.py \
    --task ${TASK} \
    --seed ${SEED}
