"""
SlowFast R50 Fine-tuning for Locomotion Classification (NO CLASS WEIGHTS)
Uses master CSV for train/val/test splits.
...
def load_splits_from_csv(master_csv, clip_col, split_col):
    """Read master CSV and return train/val/test DataFrames."""
...
# ============================================================
# 6. LIGHTNING MODULE (No class weights)
# ============================================================
...
# ============================================================
# 7. INFERENCE (TEST SET ONLY)
# ============================================================
def run_inference(model, test_df, device):
    """Run inference ONLY on the held-out test set."""
    print("\n" + "=" * 60)
