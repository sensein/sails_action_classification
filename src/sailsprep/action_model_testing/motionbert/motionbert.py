...
Run: python motionbert.py --step all --device cuda
"""
...
OUTPUT_ROOT = os.environ.get(
    "OUTPUT_ROOT",
    "/orcd/data/satra/002/projects/SAILS/action_outputs_features/action_model_outputs/single_child_videos_motion_bert/"
)
...
def finetune_action_recognition(splits, pose_dir, dirs, device="cuda"):
    ...
    """
    print("\n" + "="*70)
    print("STEP 3a: Finetuning Action Recognition")
    print("="*70)
