...
#SBATCH --output=/home/aparnabg/orcd/scratch/all_project_files/action_sota_models/mstcn_code/logs/mstcn2_%j.log
#SBATCH --error=/home/aparnabg/orcd/scratch/all_project_files/action_sota_models/mstcn_code/logs/mstcn2_%j.err

# ============================================================
# USAGE:
#   # Train all 3 seeds + aggregate:
#   sbatch --export=LABEL=loco,FEATURE=i3d run_mstcn2.sh
#
#   # Predict only (single seed):
#   sbatch --export=LABEL=loco,FEATURE=i3d,ACTION=predict,SEED=42 run_mstcn2.sh
#
#   # Aggregate existing seed results only:
#   sbatch --export=LABEL=loco,FEATURE=i3d,ACTION=evaluate run_mstcn2.sh
#
# LABEL   : loco | rmm
...
# --- Paths ---
SCRIPT_DIR=/home/aparnabg/orcd/scratch/all_project_files/action_sota_models/mstcn_code
