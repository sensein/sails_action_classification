...
#SBATCH --output=/src/sailsprep/action_model_testing/videomae2/logs/videomae_%j_%x.out
#SBATCH --error=/src/sailsprep/action_model_testing/videomae2/logs/videomae_%j_%x.err
...
SCRIPT_DIR=/src/sailsprep/action_model_testing/videomae2
