...
#SBATCH --array=0-2
#SBATCH --output=${CODE_DIR:-/src/sailsprep/action_model_testing/vjepa/clips_without_coi_crop/locomotion}/logs/probe_%A_%a.out
#SBATCH --error=${CODE_DIR:-/src/sailsprep/action_model_testing/vjepa/clips_without_coi_crop/locomotion}/logs/probe_%A_%a.err
