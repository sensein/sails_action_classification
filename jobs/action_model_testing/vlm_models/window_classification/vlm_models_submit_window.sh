...
#SBATCH --array=0-5
#SBATCH --output=/src/sailsprep/action_model_testing/vlm_models/window_classification/logs/%x_%A_%a.out
#SBATCH --error=/src/sailsprep/action_model_testing/vlm_models/window_classification/logs/%x_%A_%a.err
