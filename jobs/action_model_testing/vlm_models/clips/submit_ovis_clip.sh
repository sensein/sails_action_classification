...
#SBATCH --array=0-5
#SBATCH --output=/src/sailsprep/action_model_testing/vlm_models/clips/logs/ovis_%x_%A_%a.out
#SBATCH --error=/src/sailsprep/action_model_testing/vlm_models/clips/logs/ovis_%x_%A_%a.err
...
#
# Usage (random frame sampling — vary SEED):
