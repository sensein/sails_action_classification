...
export ACTION_OUTPUT_ROOT="/home/aparnabg/orcd/scratch/all_project_files/action_sota_models/motionbert/output_no_weights"
...
python finetune_clips.py --step all --device cuda
