...
#SBATCH --mem=80G
#SBATCH --time=6:00:00
#SBATCH --output=/home/aparnabg/orcd/pool/files_from_scratch/pose_models_test/logs/yolo_pose_%j.out
#SBATCH --error=/home/aparnabg/orcd/pool/files_from_scratch/pose_models_test/logs/yolo_pose_%j.err
