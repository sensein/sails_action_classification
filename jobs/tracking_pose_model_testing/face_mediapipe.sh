...
#SBATCH --mem=80G
#SBATCH --time=6:00:00
#SBATCH --output=${POSE_LOG_DIR:-/home/aparnabg/orcd/pool/files_from_scratch/pose_models_test/logs}/face_mediapipe_%j.out
#SBATCH --error=${POSE_LOG_DIR:-/home/aparnabg/orcd/pool/files_from_scratch/pose_models_test/logs}/face_mediapipe_%j.err
