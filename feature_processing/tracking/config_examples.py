...
from modular_pipeline import PipelineConfig, ModelConfig, FeatureConfig, ProcessingConfig, VisualizationConfig

def create_usual_config() -> PipelineConfig:
...
def config_high_detection_sensitivity():
    """Configuration with high detection sensitivity"""
    config = create_usual_config()

    # Lower detection confidence threshold to catch more detections
