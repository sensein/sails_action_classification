...
class DetectionModule:
    ...
    def _process_detection_result(self, detect_result) -> np.ndarray:
        ...
        if len(bboxes) > 0:
            ...
            valid_boxes = (
                (heights >= self.processing_config.min_height)
                & (widths >= self.processing_config.min_width)
                #& (aspect_ratios >= self.processing_config.min_aspect_ratio)
            )
...
def create_custom_config() -> PipelineConfig:
    ...
    config.export.output_path = "/home/aparnabg/orcd/scratch/tracking/colour_hist/test_pose_export.json"
...
def main():
    ...
    TARGET_VIDEO_PATH = "/home/aparnabg/orcd/scratch/tracking/colour_hist/video_out/test_pose_export.mp4"
    SOURCE_VIDEO_PATH = '/home/aparnabg/orcd/scratch/bidsdata/final_bids-dataset/derivatives/preprocessed/sub-A1H3H9Y3T1/ses-01/beh/sub-A1H3H9Y3T1_ses-01_task-dailyroutine_run-01_desc-processed_beh.mp4'
