...
Action classification and analysis of locomotion and Repetitive Motor Movements actions
from video data in the SAILS dataset, using pose estimation and tracking as
the underlying pipeline.

## Directory Overview

- `src/sailsprep/analysis/` — behavior-specific analysis modules (running, jumping, walking, crawling, crusing, rocking, spinning, handflapping, rmm_combined, loco_combined).
