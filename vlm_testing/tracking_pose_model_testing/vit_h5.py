...
parser.add_argument("--num_jobs",     type=int, default=1,
                    help="Total number of array jobs  (--array=0-N means N+1 jobs)")
...
# Distribute videos across jobs using round-robin slice
...
for vid_idx, (video_path, h5_path) in enumerate(videos_to_run):
        ...
        while cap.isOpened():
            ...
            try:
                ...
                for person in results[0]:
                    ...
                    names  = [model.config.id2label[l] for l in
                              person["labels"].cpu().numpy().tolist()]
    ...
    #     "frames": {
    #       "<frame_idx>": {
    #         "<keypoint_name>": {"x": float, "y": float, "confidence": float},
    #         ...
    #       }
    #     }
    #   }
